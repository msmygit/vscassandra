...
public abstract class DataSet<T> extends CQLTester
{
    ...
    public static class InetDataSet extends DataSet<InetAddress>
    {
        public InetDataSet()
        {
            ...
            Arrays.sort(values,
                        (o1, o2) -> TypeUtil.instance.compare(TypeUtil.instance.encode(ByteBuffer.wrap(o1.getAddress()), InetAddressType.instance, false),
                                                                      TypeUtil.instance.encode(ByteBuffer.wrap(o2.getAddress()), InetAddressType.instance, false),
