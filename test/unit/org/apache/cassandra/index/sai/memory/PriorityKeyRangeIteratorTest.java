...
public class PriorityKeyRangeIteratorTest extends AbstractKeyRangeIteratorTest
{
    ...
    protected RangeIterator makeIterator(long minimumTokenValue, long maximumTokenValue, long... tokens)
    {
        ...
        return new KeyRangeIterator(primaryKeyFactory.createKey(new Murmur3Partitioner.LongToken(minimumTokenValue)),
                                    primaryKeyFactory.createKey(new Murmur3Partitioner.LongToken(maximumTokenValue)),
                                    queue);
    }
}
