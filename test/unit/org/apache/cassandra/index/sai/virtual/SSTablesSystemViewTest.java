...
public class SSTablesSystemViewTest extends SAITester
{
    ...
    public void testVirtualTableThroughIndexLifeCycle() throws Throwable
    {
        ...
        assertTrue(SSTableIdFactory.COMPARATOR.compare(id2, id1) > 0);
        ...
        assertTrue(SSTableIdFactory.COMPARATOR.compare(id3, id2) > 0);
        ...
        assertTrue(SSTableIdFactory.COMPARATOR.compare(id4, id3) > 0);
        ...
        assertTrue(SSTableIdFactory.COMPARATOR.compare(ids5[0], id4) > 0);
    ...
    {
        return getCurrentColumnFamilyStore().getLiveSSTables().stream().map(s -> s.descriptor.id).sorted(SSTableIdFactory.COMPARATOR).toArray(SSTableId[]::new);
    }
                             ...
                             long maxSSTableRowId) throws Exception
    {
        ...
        for (SSTableIndex sstableIndex : sai.getIndexContext().getView())
        {
            ...
            if (sstable.descriptor.id.equals(id))
            {
