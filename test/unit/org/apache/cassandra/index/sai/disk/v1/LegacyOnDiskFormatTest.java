...
public class LegacyOnDiskFormatTest
{
    ...
    public void canReadPerSSTableMetadata() throws Throwable
    {
        ...
        NumericValuesMeta numericValuesMeta = new NumericValuesMeta(source.get(indexDescriptor.version.fileNameFormatter().format(IndexComponent.OFFSETS_VALUES, null)));

        assertEquals(100, numericValuesMeta.valueCount);

        numericValuesMeta = new NumericValuesMeta(source.get(indexDescriptor.version.fileNameFormatter().format(IndexComponent.TOKEN_VALUES, null)));
    ...
    public void canCreateAndUsePrimaryKeyMapWithLegacyFormat() throws Throwable
    {
        ...
        PrimaryKey expected = indexDescriptor.primaryKeyFactory.createKey(Murmur3Partitioner.instance.decorateKey(Int32Type.instance.decompose(23)).getToken());
