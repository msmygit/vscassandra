...
public class TermsIteratorMergerTest extends SAITester
{
    ...
    public void testMerger() throws Exception
    {
        ...
        {
            String term = UTF8Type.instance.compose(UTF8Type.instance.fromComparableBytes(ByteSource.peekable(merger.next().asComparableBytes(ByteComparable.Version.OSS42)), ByteComparable.Version.OSS42));
