...
public class NumericIndexWriterTest extends SAIRandomizedTester
{
    ...
    public void shouldFlushFromRamBuffer() throws Exception
    {
        ...
        try (FileHandle treeHandle = indexDescriptor.createPerIndexFileHandle(IndexComponent.BALANCED_TREE, indexContext, null);
             FileHandle treePostingsHandle = indexDescriptor.createPerIndexFileHandle(IndexComponent.POSTING_LISTS, indexContext, null);
             BlockBalancedTreeReader reader = new BlockBalancedTreeReader(indexContext,
                                                                          treeHandle,
