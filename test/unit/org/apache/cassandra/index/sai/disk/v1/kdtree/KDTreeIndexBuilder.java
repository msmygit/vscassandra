...
import org.apache.cassandra.index.sai.utils.TokenAwarePrimaryKeyFactory;
...
public class KDTreeIndexBuilder
{
    ...
    {
        private final SSTableUniqueIdentifier generation = new SequenceBasedSSTableUniqueIdentifier(0);
        private final PrimaryKey.PrimaryKeyFactory primaryKeyFactory = new TokenAwarePrimaryKeyFactory();
        ...
        {
            return primaryKeyFactory.createKey(new Murmur3Partitioner.LongToken(sstableRowId)).withSSTableRowId(sstableRowId);
        }
    ...
    private static PrimaryKey.PrimaryKeyFactory primaryKeyFactory = Version.LATEST.onDiskFormat().primaryKeyFactory(Murmur3Partitioner.instance,
    ...
    KDTreeIndexSearcher flushAndOpen() throws IOException
    {
                                                                ...
                                                                false))
        {
            ...
            metadata = new SegmentMetadata(0,
                                           ...
                                           primaryKeyFactory.createKey(Murmur3Partitioner.instance.decorateKey(UTF8Type.instance.fromString("a")).getToken()),
                                           primaryKeyFactory.createKey(Murmur3Partitioner.instance.decorateKey(UTF8Type.instance.fromString("b")).getToken()),
