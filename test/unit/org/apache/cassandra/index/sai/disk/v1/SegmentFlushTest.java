...
public class SegmentFlushTest
{
    ...
    private void testFlushBetweenRowIds(long sstableRowId1, long sstableRowId2, int segments) throws Exception
    {
        ...
        IndexDescriptor indexDescriptor = IndexDescriptor.create(new Descriptor(tmpDir.toFile(), "ks", "cf", new SequenceBasedSSTableUniqueIdentifier(1)));
        ...
        writer.addRow(PrimaryKey.DEFAULT_FACTORY.createKey(key1, Clustering.EMPTY, sstableRowId1), row1);
        ...
        writer.addRow(PrimaryKey.DEFAULT_FACTORY.createKey(key2, Clustering.EMPTY, sstableRowId2), row2);
        ...
        minKey = PrimaryKey.DEFAULT_FACTORY.createKey(key1);
        maxKey = PrimaryKey.DEFAULT_FACTORY.createKey(key2);
        minTerm = term1;
        maxTerm = term2;
        numRows = 2;
