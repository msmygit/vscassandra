...
import org.apache.cassandra.index.sai.disk.v3.postings.ScanningPostingsReader;
import org.apache.cassandra.index.sai.disk.v3.trie.TrieTermsIterator;
...
public class TermsScanner implements TermsIterator
{
    ...
    public TermsScanner(FileHandle termFile, FileHandle postingsFile, long trieRoot)
    {
        ...
        this.iterator = new TrieTermsIterator(termFile.instantiateRebufferer(), trieRoot);
        this.minTerm = ByteBuffer.wrap(ByteSourceInverse.readBytes(iterator.getMinTerm().asComparableBytes(ByteComparable.Version.OSS41)));
        this.maxTerm = ByteBuffer.wrap(ByteSourceInverse.readBytes(iterator.getMaxTerm().asComparableBytes(ByteComparable.Version.OSS41)));
    }
