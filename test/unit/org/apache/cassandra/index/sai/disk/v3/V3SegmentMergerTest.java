...
// TODO: use a common base class with SegmentMergerTest?
public class V3SegmentMergerTest extends SAITester
{
    protected static final Injections.Counter SEGMENT_BUILD_COUNTER = Injections.newCounter("SegmentBuildCounter")
                                                                                .add(newInvokePoint().onClass(V3SSTableIndexWriter.class).onMethod("newSegmentBuilder"))
                                                                                .build();
