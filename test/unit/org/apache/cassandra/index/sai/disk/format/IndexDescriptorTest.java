...
public class IndexDescriptorTest
{
    ...
    public void versionAAPerSSTableComponentIsParsedCorrectly() throws Throwable
    {
        ...
        IndexDescriptor indexDescriptor = IndexDescriptor.create(descriptor, Murmur3Partitioner.instance, PrimaryKey.EMPTY_COMPARATOR);
    ...
    public void allVersionAAPerSSTableComponentsAreLoaded() throws Throwable
    {
        ...
        IndexDescriptor result = IndexDescriptor.create(descriptor, Murmur3Partitioner.instance, PrimaryKey.EMPTY_COMPARATOR);
