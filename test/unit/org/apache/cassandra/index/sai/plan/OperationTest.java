...
//        controller = new QueryController(BACKEND, command, null, Version.LATEST.onDiskFormat().indexFeatureSet(), new QueryContext(), null);
//
//        command = PartitionRangeReadCommand.allDataRead(CLUSTERING_BACKEND.metadata(), FBUtilities.nowInSeconds());
//        controllerClustering = new QueryController(CLUSTERING_BACKEND, command, null, Version.LATEST.onDiskFormat().indexFeatureSet(), new QueryContext(), null);
//
//        command = PartitionRangeReadCommand.allDataRead(STATIC_BACKEND.metadata(), FBUtilities.nowInSeconds());
//        controllerStatic = new QueryController(STATIC_BACKEND, command, null, Version.LATEST.onDiskFormat().indexFeatureSet(), new QueryContext(), null);
//    }
//
//    @After
