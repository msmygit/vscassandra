...
public class CompactionsPurgeTest
{
    ...
    public void testMajorCompactionPurge()
    {
        ...
        ImmutableArrayBackedPartition partition = Util.getOnlyPartitionUnfiltered(Util.cmd(cfs, key).build());
    ...
    public void testMinorCompactionPurge()
    {
        ...
        ImmutableArrayBackedPartition partition = Util.getOnlyPartitionUnfiltered(Util.cmd(cfs, key1).build());
        assertEquals(1, partition.rowCount());
    }
    ...
    public void testMinTimestampPurge()
    {
        ...
        ImmutableArrayBackedPartition partition = Util.getOnlyPartitionUnfiltered(Util.cmd(cfs, key3).build());
