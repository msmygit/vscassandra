...
@State(Scope.Thread)
public class WriteBlockMemoryIndexBenchmark extends AbstractTrieMemoryIndexBenchmark
{
    ...
    @Benchmark
    public long writeIntegerBlockIndex()
    {
        long size = 0;
        int rowCount = 0;
        int keyCount = 0;
    ...
    @Benchmark
    public long writeIntegerTrieIndex()
    {
        long size = 0;
        int rowCount = 0;
        int keyCount = 0;
