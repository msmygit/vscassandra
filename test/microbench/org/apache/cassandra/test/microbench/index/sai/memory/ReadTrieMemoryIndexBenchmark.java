...
public class ReadTrieMemoryIndexBenchmark extends AbstractTrieMemoryIndexBenchmark
{
    ...
    public void initialiseIndexes()
    {
        ...
        {
            stringIndex.add(partitionKeys[keyCount], Clustering.EMPTY, stringTerms[i], null);
            integerIndex.add(partitionKeys[keyCount], Clustering.EMPTY, integerTerms[i], null);
