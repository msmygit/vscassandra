...
public class ReadTrieMemoryIndexBenchmark extends AbstractTrieMemoryIndexBenchmark
{
    ...
    public void initialiseIndexes()
    {
        ...
        {
            stringIndex.add(partitionKeys[keyCount], Clustering.EMPTY, stringTerms[i], false);
            integerIndex.add(partitionKeys[keyCount], Clustering.EMPTY, integerTerms[i], false);
