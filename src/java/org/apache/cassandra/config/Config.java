...
public class Config
{
    ...
    public volatile int table_count_warn_threshold = emulate_dbaas_defaults ? Integer.MAX_VALUE : 150;
    public volatile int keyspace_count_warn_threshold = emulate_dbaas_defaults ? Integer.MAX_VALUE : 40;
