...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean
{
    ...
    public void replacedEndpoint(InetAddressAndPort endpoint)
    {
        ...
        Nodes.peers().remove(endpoint, true);
    ...
    private EndpointState putEndpointState(InetAddressAndPort endpoint, EndpointState state)
    {
        if (state != null)
        {
    ...
    private EndpointState putEndpointStateIfAbsent(InetAddressAndPort endpoint, EndpointState state)
    {
        if (state != null)
            state.maybeSetUpdater(update -> Nodes.updateLocalOrPeer(endpoint, update, false));
