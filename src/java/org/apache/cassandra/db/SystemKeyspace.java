...
public final class SystemKeyspace
{
    ...
    public static SetMultimap<InetAddressAndPort, Token> loadTokens()
    {
        ...
        Nodes.peers().get().forEach(info -> tokenMap.putAll(info.getPeerAddressAndPort(), info.getTokens()));
        return tokenMap;
    }
    ...
    {
        return Nodes.peers().get().collect(Collectors.toMap(PeerInfo::getPeerAddressAndPort, NodeInfo::getHostId));
    }
    ...
    public static InetAddressAndPort getPreferredIP(InetAddressAndPort ep)
    {
        ...
        if (info != null && info.getPreferredAddressAndPort() != null)
    ...
    public static Map<InetAddressAndPort, Map<String, String>> loadDcRackInfo()
    {
        return Nodes.peers()
                    .get()
                    .filter(p -> p.getDataCenter() != null && p.getRack() != null)
    ...
    public static CassandraVersion getReleaseVersion(InetAddressAndPort ep)
    {
        if (FBUtilities.getBroadcastAddressAndPort().equals(ep))
            ...
            return Nodes.peers().get(ep).getReleaseVersion();
    }
