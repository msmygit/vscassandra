...
public final class PeerInfo extends NodeInfo<PeerInfo>
{
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(getPeerAddressAndPort(), peerInfo.getPeerAddressAndPort()) && Objects.equals(getPreferredAddressAndPort(), peerInfo.getPreferredAddressAndPort());
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(super.hashCode(), getPeerAddressAndPort(), getPreferredAddressAndPort());
    }
