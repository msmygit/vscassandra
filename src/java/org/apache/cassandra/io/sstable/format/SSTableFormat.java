...
public interface SSTableFormat<R extends SSTableReader, W extends SSTableWriter>
{
    ...
    interface SSTableReaderFactory<R extends SSTableReader, B extends SSTableReader.Builder<R, B>>
    {
         ...
         * {@link SSTableReaderLoadingBuilder#build(SSTable.Owner, boolean, boolean)} and passed those resources to the created
    ...
    interface SSTableWriterFactory<W extends SSTableWriter, B extends SSTableWriter.Builder<W, B>>
    {
         ...
         * It should not let the caller passing any closeable resources directly. Instead, it should collect all the
         * parameters required to open those resources and does that when {@link SSTableWriter.Builder#build(LifecycleNewTracker)}
         * is called. If building fails, all the opened resources should be released.
         */
