...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    */
    ...
    private void handleStateBootstrap(InetAddressAndPort endpoint)
    {
        ...
        getTokenMetadata().updateHostId(Nodes.localOrPeerInfo(endpoint).getHostId(), endpoint);
    }
    ...
    private void handleStateBootreplacing(InetAddressAndPort newNode, String[] pieces)
    {
        ...
        getTokenMetadata().updateHostId(Nodes.localOrPeerInfo(newNode).getHostId(), newNode);
    }
    ...
    private void handleStateNormal(final InetAddressAndPort endpoint, final String status)
    {
        ...
        UUID hostId = Nodes.localOrPeerInfo(endpoint).getHostId();
        InetAddressAndPort existing = getTokenMetadata().getEndpointForHostId(hostId);
        if (replacing && isReplacingSameAddress() && Gossiper.instance.getEndpointStateForEndpoint(DatabaseDescriptor.getReplaceAddress()) != null
            && (Objects.equals(hostId, Nodes.localOrPeerInfo(DatabaseDescriptor.getReplaceAddress()).getHostId())))
