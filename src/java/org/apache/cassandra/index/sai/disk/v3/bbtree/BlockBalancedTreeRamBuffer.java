...
{
    private final MemtableTrie<PackedLongValues.Builder> trie;
    ...
    {
        trie = new MemtableTrie<>(TrieMemtable.BUFFER_TYPE);
    ...
    private static class PostingsAccumulator implements MemtableTrie.UpsertTransformer<PackedLongValues.Builder, Integer>
    {
