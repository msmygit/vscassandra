 ...
 * @see Directory
 */
public abstract class Lucene8xIndexInput extends Lucene8xDataInput implements Cloneable, Closeable {
   ...
   */
  @Override
  public Lucene8xIndexInput clone() {
    return (Lucene8xIndexInput) super.clone();
  }
   ...
   */
  public abstract Lucene8xIndexInput slice(String sliceDescription, long offset, long length) throws IOException;
  ...
  public RandomAccessInput randomAccessSlice(long offset, long length) throws IOException {
    ...
    if (slice instanceof RandomAccessInput) {
      ...
      return new RandomAccessInput() {
        ...
        @Override
        public String toString() {
          return "RandomAccessInput(" + Lucene8xIndexInput.this.toString() + ")";
        }
      };
    }
  }
