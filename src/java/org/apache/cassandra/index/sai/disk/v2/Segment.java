...
public class Segment implements Closeable
{
    ...
    public Segment(IndexContext columnContext, SSTableContext sstableContext, PerIndexFiles indexFiles, SegmentMetadata metadata) throws IOException
    {
    ...
    @VisibleForTesting
    public Segment(PrimaryKeyMap primaryKeyMap, PerIndexFiles indexFiles, SegmentMetadata metadata, AbstractType<?> columnType)
    {
