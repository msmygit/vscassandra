...
public class BlockIndexWriter
{
    ...
    public BlockIndexWriter(String indexName, IndexDescriptor indexDescriptor) throws IOException
    {
        this.indexName = indexName;
        this.indexDescriptor = indexDescriptor;
        this.valuesOut = indexDescriptor.openOutput(IndexComponent.Type.TERMS_DATA, indexName);
...
//        System.out.println("realLeafFilePointers=" + realLeafBytesFPs);
        ...
        final IndexOutput bigPostingsOut = this.indexDescriptor.openOutput(IndexComponent.create(IndexComponent.Type.KD_TREE_POSTING_LISTS, indexName));
