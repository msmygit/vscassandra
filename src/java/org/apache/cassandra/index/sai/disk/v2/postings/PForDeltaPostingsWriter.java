...
public class PForDeltaPostingsWriter implements Closeable
{
    ...
    @VisibleForTesting
    public PForDeltaPostingsWriter(IndexDescriptor indexDescriptor, IndexContext indexContext, boolean segmented) throws IOException
    {
    ...
    public PForDeltaPostingsWriter(IndexDescriptor indexDescriptor, IndexContext indexContext, int blockSize, boolean segmented) throws IOException
    {
        this(indexDescriptor.openPerIndexOutput(IndexComponent.POSTING_LISTS, indexContext), blockSize);
    }
