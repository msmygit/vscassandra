...
public class V3ColumnQueryMetrics extends ColumnQueryMetrics implements QueryEventListener.TrieIndexEventListener, QueryEventListener.BKDIndexEventListener
{
    ...
    public V3ColumnQueryMetrics(String indexName, TableMetadata table)
    {
        super(indexName, table);

        bkdIndexMetrics = new BKDIndexMetrics(indexName, table);
        trieIndexMetrics = new TrieIndexMetrics(indexName, table);
    }
