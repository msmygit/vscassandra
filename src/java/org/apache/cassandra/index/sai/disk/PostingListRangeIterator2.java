...
@NotThreadSafe
public class PostingListRangeIterator2 extends RangeIterator
{
     ...
     */
    public PostingListRangeIterator2(PrimaryKeyMap primaryKeyMap,
...
//                logger.error(indexContext.logMessage("Unable to provide next token!"), t);
    ...
    private long getNextSegmentRowId() throws IOException
    {
        if (needsSkipping)
        {
            long segmentRowId = postingList.advance(skipToToken.sstableRowId(primaryKeyMap));
