...
public interface SegmentMerger extends Closeable
{
    ...
    SegmentMetadata merge(IndexContext context, IndexComponents components, PrimaryKey minKey, PrimaryKey maxKey, long maxSSTableRowId) throws IOException;
    ...
    class LiteralSegmentMerger implements SegmentMerger
    {
        ...
        @Override
        public SegmentMetadata merge(IndexContext context, IndexComponents components, PrimaryKey minKey, PrimaryKey maxKey, long maxSSTableRowId) throws IOException
        {
