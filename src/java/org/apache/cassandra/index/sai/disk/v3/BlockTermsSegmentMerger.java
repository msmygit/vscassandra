...
public class BlockTermsSegmentMerger implements SegmentMerger
{
    ...
    private final List<BlockTermsReader.PointsIterator> segmentIterators = new ArrayList<>();
    ...
    private BlockTermsReader.PointsIterator createIterator(IndexContext indexContext,
                                                           SegmentMetadata segment,
                                                           V3PerIndexFiles indexFiles) throws IOException
    {
        final BlockTermsReader reader = new BlockTermsReader(indexFiles.indexDescriptor(),
                                                             indexContext,
                                                             indexFiles,
    ...
    public void close()
    {
        for (BlockTermsReader.PointsIterator iterator : segmentIterators)
