 ...
 */
public class V2PerIndexFiles implements Closeable
{
    ...
    public V2PerIndexFiles(IndexDescriptor indexDescriptor, IndexContext columnContext)
    {
        this(indexDescriptor, columnContext, false);
    }

    public V2PerIndexFiles(IndexDescriptor indexDescriptor, IndexContext columnContext, boolean temporary)
    {
