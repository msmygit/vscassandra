 ...
 *
 * Based on {@link org.apache.cassandra.index.sai.disk.v1.postings.FilteringPostingList}
 */
@NotThreadSafe
public class FilteringPostingList implements PostingList
{
    ...
    public FilteringPostingList(long cardinality, Filter filter, OrdinalPostingList delegate)
    {
