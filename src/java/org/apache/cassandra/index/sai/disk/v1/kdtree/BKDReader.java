...
import org.apache.cassandra.index.sai.disk.v1.FilteringPostingList;
...
//>>>>>>> a1c417a8f0 (STAR-158: Add on-disk version support to SAI):src/java/org/apache/cassandra/index/sai/disk/v1/readers/BKDReader.java
    ...
    public class IteratorState extends AbstractIterator<Long> implements Comparable<IteratorState>, Closeable
    {
        ...
        public IteratorState(DocMapper docMapper) throws IOException
        {
            ...
            sharedInput = postingsFile == null ? null : new SharedIndexInput(IndexFileUtils.instance.openInput(postingsFile));
    ...
    public List<PostingList.PeekablePostingList> intersect(IntersectVisitor visitor, QueryEventListener.BKDIndexEventListener listener, QueryContext context)
    {
        ...
        final SharedIndexInput sharedInput = new SharedIndexInput(IndexFileUtils.instance.openInput(postingsFile));
        final PackedIndexTree index = new PackedIndexTree();
        ...
        relation == Relation.CELL_INSIDE_QUERY ? new Intersection(bkdInput, sharedInput, index, listener, context)
                                               : new FilteringIntersection(bkdInput, sharedInput, index, visitor, listener, context);
