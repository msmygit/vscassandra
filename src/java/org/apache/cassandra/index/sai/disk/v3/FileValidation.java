...
public class FileValidation
{
     ...
     * @throws IOException Error reading meta data
     */
    public static Meta createValidate(long rootFP, final IndexInput input) throws IOException
    {
        ...
        else
        {
            ...
            final long crc0 = loadCRCValue(rootFP, BLOCK_SIZE, input, crc);
            final long crc1 = loadCRCValue(fp1, BLOCK_SIZE, input, crc);

            return new Meta(rootFP, BLOCK_SIZE, crc0, fp1, BLOCK_SIZE, crc1);
        }
    }
     ...
     * @throws IOException Error loading metadata
     */
