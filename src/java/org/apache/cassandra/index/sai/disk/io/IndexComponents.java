...
//    public static final String LEGACY_PER_COLUMN_FILE_NAME_FORMAT = "%s_" + PER_SSTABLE_FILE_NAME_FORMAT;
    ...
    public IndexInput openLuceneInput(FileHandle handle) throws IOException
    {
        ...
        final boolean useUnmap = useUnmapHack;
    ...
    static {
        final Object hack = AccessController.doPrivileged((PrivilegedAction<Object>) IndexComponents::unmapHackImpl);
    ...
    final ByteBuffer[] map(String resourceDescription,
                           FileChannel fc,
                           long offset,
                           long length,
