...
public class V3OnDiskFormat implements OnDiskFormat
{
    private static final Logger logger = LoggerFactory.getLogger(V3OnDiskFormat.class);
    ...
    {
        return new V3SSTableIndex(sstableContext, indexContext);
    }
