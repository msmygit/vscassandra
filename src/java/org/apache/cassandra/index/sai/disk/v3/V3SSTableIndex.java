...
import org.apache.cassandra.index.sai.disk.v3.segment.Segment;
 ...
 * index is segmented
 */
public class V3SSTableIndex extends SSTableIndex
{
    ...
    public V3SSTableIndex(SSTableContext sstableContext, IndexContext indexContext)
    {
