...
import org.apache.cassandra.index.sai.disk.v3.bitpack.BlockPackedReader;
import org.apache.cassandra.index.sai.disk.v3.bitpack.MonotonicBlockPackedReader;
import org.apache.cassandra.index.sai.disk.v3.bitpack.NumericValuesMeta;
import org.apache.cassandra.index.sai.disk.v3.keystore.KeyLookup;
import org.apache.cassandra.index.sai.disk.v3.keystore.KeyLookupMeta;
...
public class SkinnyPrimaryKeyMap implements PrimaryKeyMap
{
    ...
    protected DecoratedKey readPartitionKey(long sstableRowId)
    {
        ...
        ByteSource.Peekable peekable = ByteSource.peekable(partitionKeyCursor.seekToPointId(partitionId).asComparableBytes(ByteComparable.Version.OSS41));
