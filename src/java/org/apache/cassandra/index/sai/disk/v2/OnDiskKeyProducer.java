...
public class OnDiskKeyProducer
{
    ...
    private final V2SSTableContext.KeyFetcher keyFetcher;
    ...
    public OnDiskKeyProducer(V2SSTableContext.KeyFetcher keyFetcher, RandomAccessReader reader, LongArray segmentRowIdToOffset, long maxPartitionOffset)
    {
