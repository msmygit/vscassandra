...
/**
 * SearchableIndex for the version 3 index format.
 */
@NotThreadSafe
public class V3SearchableIndex implements SearchableIndex
{
    ...
    private V3PerIndexFiles indexFiles;

    public V3SearchableIndex(SSTableContext sstableContext, IndexContext indexContext)
    {
        this.indexContext = indexContext;
        try
        {
            this.indexFiles = new V3PerIndexFiles(sstableContext.indexDescriptor, indexContext, false);
            ...
            {
                segmentsBuilder.add(new V3Segment(indexContext, sstableContext, indexFiles, metadata));
            }
