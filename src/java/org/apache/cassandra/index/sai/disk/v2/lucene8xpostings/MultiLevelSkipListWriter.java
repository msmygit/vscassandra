...
public abstract class MultiLevelSkipListWriter {
  ...
  protected MultiLevelSkipListWriter(int skipInterval, int skipMultiplier, int maxSkipLevels, long df) {
   ...
   */
  public void bufferSkip(long df) throws IOException {
    assert df % skipInterval == 0 : "df="+df+" skipInterval="+skipInterval;
    int numLevels = 1;
    df /= skipInterval;
