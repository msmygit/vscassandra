 ...
 */
@NotThreadSafe
public class V3InvertedIndexWriter implements Closeable, BlockTermsWriter.TermRowIDCallback
{
    ...
    @Override
    public void added(BytesRef term, long rowid) throws IOException
    {
    ...
    public void finish(SegmentMetadata.ComponentMetadataMap components) throws IOException
    {
        ...
        map.put(SAICodecUtils.FOOTER_POINTER, Long.toString(footerPointer.getValue()));
    ...
    {
        FileUtils.closeQuietly(postingsWriter, termsDictionaryWriter);
    }
}
