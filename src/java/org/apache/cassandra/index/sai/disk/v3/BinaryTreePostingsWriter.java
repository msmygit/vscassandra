...
/**
 * Writes upper level postings based on {@link OneDimBKDPostingsWriter} for the
 * block terms index implementation.
 */
@NotThreadSafe
public class BinaryTreePostingsWriter implements BinaryTree.BinaryTreeTraversalCallback
{
    ...
    public Result finish(BlockTermsReader reader, IndexOutput out, IndexContext indexContext) throws IOException
    {
                         ...
                         IndexContext indexContext) throws IOException
    {
        ...
        // not in try finally because out is closed elsewhere
        ...
        try (final IndexInput leafPostingsInput = IndexInputReader.create(postingsHandle))
        {
            ...
            logger.debug("Flushed {} upper posting list, saw {} leaves for binary-tree nodes in {} ms.",
