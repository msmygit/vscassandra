...
public abstract class SegmentBuilder
{
    ...
    private HllSketch sketch = new HllSketch();
    ...
    public static class KDTreeSegmentBuilder extends SegmentBuilder
    {
        ...
        @Override
        protected ComponentMetadataMap flushInternal(IndexDescriptor indexDescriptor, IndexContext indexContext) throws IOException
        {
    ...
    public SegmentMetadata flush(IndexDescriptor indexDescriptor, IndexContext indexContext) throws IOException
    {
        ...
        ComponentMetadataMap indexMetas = flushInternal(indexDescriptor, indexContext);

        return new SegmentMetadata(segmentRowIdOffset, rowCount, minSSTableRowId, maxSSTableRowId, minKey, maxKey, minTerm, maxTerm, sketch, indexMetas);
    }
    ...
    public long add(ByteBuffer term, PrimaryKey key, long sstableRowId)
    {
        ...
        sketch.update(ByteBufferUtil.getArray(term));
    ...
    protected abstract ComponentMetadataMap flushInternal(IndexDescriptor indexDescriptor, IndexContext indexContext) throws IOException;
