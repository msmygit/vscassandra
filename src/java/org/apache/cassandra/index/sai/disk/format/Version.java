...
public class Version
{
    ...
    public static final List<Version> ALL = Lists.newArrayList(AA, BA, CA);
    ...
    public static final Version LATEST = parse(System.getProperty("cassandra.sai.latest.version", "ca")); // parse("ca");
