 ...
 * <p>
 * While this inherits the threading behaviour of {@link MemtableTrie} of single-writer / multiple-reader,
...
{
    private static final MemtableTrie.UpsertTransformer<Long, Long> OVERWRITE_TRANSFORMER = (existing, update) -> update;
