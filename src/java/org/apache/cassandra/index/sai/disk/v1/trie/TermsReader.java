...
public class TermsReader implements Closeable
{
    ...
    public class TermQuery
    {
        ...
        TermQuery(ByteComparable term, QueryEventListener.TrieIndexEventListener listener, QueryContext context)
        {
            ...
            postingsInput = new SharedIndexInput(IndexFileUtils.instance.openInput(postingsFile));
            this.term = term;
    ...
    private class TermsScanner implements TermsIterator
    {
        ...
        public PostingList postings() throws IOException
        {
            ...
            return new OffsetPostingList(segmentOffset,
                                         new PostingsReader(sharedInput.sharedCopy(),
                                                            new PostingsReader.BlocksSummary(sharedInput.sharedCopy(), entry.right),
