...
import org.apache.cassandra.index.sai.disk.v3.keystore.KeyStoreWriter;
...
public class SSTableComponentsWriter implements PerSSTableIndexWriter
{
    ...
    @Override
    public void startPartition(DecoratedKey partitionKey, long keyPosition) throws IOException
    {
        partitionId++;
