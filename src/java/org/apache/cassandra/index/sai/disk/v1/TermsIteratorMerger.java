...
public class TermsIteratorMerger implements TermsIterator
{
    ...
    {
        byte[] bytes = ByteSourceInverse.readBytes(minTerm.asComparableBytes(ByteComparable.Version.OSS42));
    ...
    {
        byte[] bytes = ByteSourceInverse.readBytes(maxTerm.asComparableBytes(ByteComparable.Version.OSS42));
        return ByteBuffer.wrap(bytes);
    }
