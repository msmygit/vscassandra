...
package org.apache.cassandra.index.sai.cuckoofilter;
...
import org.apache.cassandra.index.sai.cuckoofilter.Utils.Algorithm;
import org.apache.cassandra.index.sai.cuckoofilter.Utils.Victim;
...
public final class CuckooFilter<T> implements Serializable {
	...
	public static class Builder<T> {
		...
		public CuckooFilter<T> build() {
			...
			IndexTagCalc<T> hasher = IndexTagCalc.create(hashAlgorithm, funnel, numBuckets, tagBits);
