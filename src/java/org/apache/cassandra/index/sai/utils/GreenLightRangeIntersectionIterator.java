...
public class GreenLightRangeIntersectionIterator extends RangeIterator
{
    ...
    private GreenLightRangeIntersectionIterator(Builder.Statistics statistics, List<RangeIterator> ranges)
    {
        super(statistics);
        this.ranges = ranges;
    ...
    protected PrimaryKey computeNext()
    {
        ...
        while (!ranges.isEmpty())
        {
            ...
            else
            {
                ...
                boolean notUniqueMatch = !candidate.unique() || !range.getCurrent().unique();
                if (cmp == 0 || notUniqueMatch)
                {
                    System.out.println("notUniqueMatch="+notUniqueMatch);
                    range.hasNext();
    ...
    public static class Builder extends RangeIterator.Builder
    {
        ...
        private static RangeIterator buildIterator(Statistics statistics, List<RangeIterator> ranges)
        {
            ...
            return new GreenLightRangeIntersectionIterator(statistics, ranges);
        }
    }
