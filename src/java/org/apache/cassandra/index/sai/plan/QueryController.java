...
public class QueryController
{
    ...
    {
        StorageAttachedIndex index = cfs.indexManager.getBestIndexFor(expression, StorageAttachedIndex.class).orElse(null);

        return index == null ? new IndexContext(cfs.metadata().keyspace,
                                                cfs.metadata().name,
