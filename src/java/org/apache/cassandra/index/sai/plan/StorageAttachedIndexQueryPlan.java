...
public class StorageAttachedIndexQueryPlan implements Index.QueryPlan
{
    ...
    {
        return new StorageAttachedIndexSearcher(cfs, queryMetrics, command, filterOperation, indexFeatureSet, DatabaseDescriptor.getRangeRpcTimeout(TimeUnit.MILLISECONDS));
    }
